...
# C Compiler Flags
CFLAGS=-mcpu=cortex-m3 -mthumb -gdwarf-2 -MD -Wall -O1 -fdata-sections -ffunction-sections

# CC Compiler Flags
CCFLAGS=-mcpu=cortex-m3 -mthumb -gdwarf-2 -MD -Wall -O1 -fdata-sections -ffunction-sections -fno-exceptions
CXXFLAGS=-mcpu=cortex-m3 -mthumb -gdwarf-2 -MD -Wall -O1 -fdata-sections -ffunction-sections -fno-exceptions
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mstn_template

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mstn_template: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mstn_template ${OBJECTFILES} ${LDLIBSOPTIONS} -u _printf_float -mcpu=cortex-m3 -mthumb -lstdc++ -nostartfiles -lm -N -Ttext=0x08003000 -Tdata=0x20000000 --specs=nano.specs -Wl,--start-group -lgcc -lc -lm -lMSTN-M100 -Wl,--end-group -Wl,-gc-sections -ffreestanding -T/opt/Intec/MSTN/M100/Lib/arm-none-eabi/MSTN_M100_User.ld -Wl,--start-group -lgcc -lc -lm -lMSTN-M100 -Wl,--end-group
